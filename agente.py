...
def diagnostico(texto_usuario):
    ...
    basado en palabras clave detectadas.
    """
    texto_usuario = texto_usuario.lower()

    # Lista de síntomas clave
    sintomas_clave = [
        "fiebre", "tos", "dolor de cabeza", "náuseas", 
        "dolor abdominal", "diarrea", "estornudos", "congestión"
    ]

    # Buscar qué síntomas aparecen en el texto
    ...
    # Reglas del agente (de 1, 2 o 3 síntomas)
    reglas = {
    ...
    # Si no hay coincidencia exacta, devolver síntomas detectados
...
def menu():
    ...
    print("Describa sus síntomas en una frase (ej: Tengo tos y dolor de cabeza).")
